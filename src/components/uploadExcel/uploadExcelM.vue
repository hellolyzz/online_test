...
<template>
  <div class="app-container">
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>添加选择题题库</el-breadcrumb-item>
...
export default {
  ...
  methods: {
    ...
    add(i, length) {
      ...
      form.optionA = this.tableData[i].optionA;
      form.optionB = this.tableData[i].optionB;
      form.optionC = this.tableData[i].optionC;
      form.optionD = this.tableData[i].optionD;
    ...
    async addMultiQ(form) {
      ...
      this.$message.success("批量导入选择题成功");
